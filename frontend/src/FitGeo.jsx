  ...
  return (
    <div style={{ padding: "0 16px 16px" }}>
      ...
      <div className="fu3">
        ...
        <div className="card">
          {[{ meal: "საუზმე", items: state.diary.breakfast, icon: "🌅" }, { meal: "სადილი", items: state.diary.lunch, icon: "☀️" }, { meal: "ვახშამი", items: state.diary.dinner, icon: "🌙" }].map(({ meal, items, icon }) => (
...
სიმაღლე: ${profile?.height || "?"}სმ, წონა: ${profile?.weight || "?"}კგ,
მიზანი: ${profile?.goal === "lose" ? "წონის დაკლება" : profile?.goal === "gain" ? "მასის მომატება" : profile?.goal === "maintain" ? "შენარჩუნება" : "ჯანმრთელობა"},
აქტივობა: ${profile?.activity || "?"},
კალორიების მიზანი: ${state.calories?.goal || 2200} kcal.
...
function useBaseInputs() {
  ...
  const [h, setH] = useState(profile?.height || "175");
  const [w, setW] = useState(profile?.weight || "75");
  const [a, setA] = useState(profile?.age || "25");
...
const MEAL_DB = {
  ...
  breakfast: [
    { id:"b1",  name:"შვრია ბანანით",             emoji:"🥣", kcal:380, p:12, c:65, f:8,  time:5,  ing:["შვრია 80გ","ბანანი 1ც","რძე 200მლ","თაფლი 1ჩ"] },
    { id:"b2",  name:"კვერცხი პურით",              emoji:"🍳", kcal:420, p:22, c:32, f:18, time:10, ing:["კვერცხი 3ც","პური 2ნ","კარაქი 1ჩ","მარილი"] },
    { id:"b3",  name:"ხაჭო კენკრით",               emoji:"🍓", kcal:320, p:18, c:38, f:8,  time:5,  ing:["ხაჭო 200გ","მარწყვი 100გ","ბლუბერი 50გ","თაფლი 2ჩ"] },
    { id:"b4",  name:"გრეჩიხა რძით",               emoji:"🫕", kcal:370, p:13, c:68, f:7,  time:15, ing:["გრეჩიხა 80გ","რძე 150მლ","კარაქი 1ჩ","მარილი"] },
    { id:"b5",  name:"ომლეტი ბოსტნეულით",          emoji:"🥚", kcal:360, p:24, c:12, f:22, time:10, ing:["კვერცხი 3ც","ბულგ.პილპ. 1/2","პომიდ. 1","ყველი 30გ"] },
    { id:"b6",  name:"შვრია ნიგოზ-ვაშლით",        emoji:"🌰", kcal:440, p:14, c:58, f:18, time:5,  ing:["შვრია 80გ","ნიგოზი 30გ","ჩია 10გ","ვაშლი 1/2","თაფლი"] },
    { id:"b7",  name:"ხაჭაპური მინი",              emoji:"🧀", kcal:480, p:18, c:52, f:22, time:20, ing:["ცომი 100გ","ხაჭო 80გ","ყველი 40გ","კვერცხი 1"] },
    { id:"b8",  name:"კვერცხი ავოკადოთი",           emoji:"🥑", kcal:460, p:20, c:18, f:32, time:10, ing:["კვერცხი 2ც","ავოკადო 1/2","პური 2ნ","ლიმ.","მარ."] },
    { id:"b9",  name:"პროტ.შეიქი ხილით",          emoji:"💪", kcal:400, p:35, c:45, f:8,  time:3,  ing:["პ.შეიქი 1 სკ.","ბანანი 1","მოცვი 100გ","რძე 200მლ"] },
    { id:"b10", name:"მიუსლი იოგურტით",            emoji:"🥗", kcal:430, p:16, c:62, f:12, time:5,  ing:["მიუსლი 80გ","ბ.იოგ. 200გ","ნახ.ხილი 30გ","თაფლი"] },
    { id:"b11", name:"ბლინები ხაჭოთი",              emoji:"🥞", kcal:500, p:22, c:58, f:18, time:20, ing:["ფქვილი 100გ","კვ. 2","ხაჭო 100გ","რძე 100მლ","შაქ.1ჩ"] },
    { id:"b12", name:"ბრინჯის ფაფა ვაშლით",        emoji:"🍚", kcal:350, p:8,  c:70, f:5,  time:15, ing:["ბრინჯი 70გ","ვაშლი 1","ყინ.კენკ. 50გ","დარიჩ.","თაფ."] },
    { id:"b13", name:"ტოსტი ყველ-პომიდვრით",       emoji:"🍞", kcal:390, p:16, c:42, f:16, time:7,  ing:["პური 2ნ","სულ.ყველი 50გ","პომ. 1","მწვ.ბ.პ.","ბაზ."] },
    { id:"b14", name:"შვრია მანდარინით",             emoji:"🍊", kcal:340, p:11, c:60, f:6,  time:5,  ing:["შვრია 70გ","მანდარინი 2","ბ.იოგ. 100გ","ჩია 5გ","თაფ."] },
    { id:"b15", name:"კვერცხი სოკოთი",              emoji:"🍄", kcal:310, p:24, c:8,  f:20, time:12, ing:["კვ. 3ც","შამპ. 100გ","ისპ. 50გ","ზეთი 1ჩ","ნიორი"] },
    { id:"b16", name:"მჭადი ყველ-კარაქით",          emoji:"🌽", kcal:450, p:14, c:55, f:20, time:15, ing:["სიმინდ.ფქ. 100გ","სულ.ყ. 50გ","კარაქი 15გ","მარ.","წყ."] },
    { id:"b17", name:"ხაჭოიანი ტოსტი",             emoji:"🥪", kcal:410, p:20, c:38, f:18, time:8,  ing:["პური 2ნ","ხაჭო 100გ","კიტ.ოგ.","მარ.","ზ.ზეთი 1ჩ"] },
    { id:"b18", name:"კვერცხი ისპ.ყ.",             emoji:"🍳", kcal:330, p:26, c:6,  f:22, time:8,  ing:["კვ. 3ც","ახ.ისპ. 100გ","ყ. 30გ","ნ.","ზ. 1ჩ"] },
    { id:"b19", name:"შვრია ჩირით",                emoji:"🍑", kcal:410, p:12, c:72, f:8,  time:5,  ing:["შვ. 80გ","ქ.ჩირი 30გ","ინ.ჩ. 20გ","კ. 200მლ","ვ.1ჩ"] },
    { id:"b20", name:"ბანანის სმუზი-ბოული",        emoji:"🫙", kcal:380, p:14, c:68, f:6,  time:5,  ing:["ბ. 2ც","ბ.იოგ. 150გ","კ.კენ. 50გ","მ.30გ","ჩ.5გ"] },
    { id:"b21", name:"ქართ.ომლ.მწვ.ბოსტ.",        emoji:"🫑", kcal:370, p:22, c:14, f:24, time:12, ing:["კვ. 3ც","მწ.ბ.პ. 1","ნ.1","ქ.","კ.40გ","ზ.1ჩ"] },
    { id:"b22", name:"პური ნუშ.კ.+ბ.",            emoji:"🥜", kcal:430, p:14, c:48, f:20, time:5,  ing:["პ.2ნ","ნ.კ. 2ჩ","ბ. 1ც","ჩ.ჩ. 1ჩ","ბ.კ.5გ"] },
    { id:"b23", name:"ყველ-კვერ.ბლინი",           emoji:"🧇", kcal:490, p:24, c:46, f:22, time:18, ing:["ფქვ.80გ","კვ.2","ს.ყ.40გ","რ.100მლ","შ.","კ.1ჩ"] },
    { id:"b24", name:"კვინოა ვ-ნ.+ი-ო.",          emoji:"🍲", kcal:360, p:16, c:58, f:8,  time:15, ing:["კვ. 70გ","ვ. 1ც","ბ.იოგ.100გ","ნ.10გ","ვ.ჩ.1ჩ"] },
    { id:"b25", name:"კვ.ბ.+ოგ.+ი-ო.",           emoji:"🫙", kcal:290, p:20, c:28, f:10, time:5,  ing:["ბ.იოგ.200გ","კ.1ც","კ.ო.1/2","ვ.","ბ.კ."] },
    { id:"b26", name:"ბრ.+ლ.+ი.",                 emoji:"🍛", kcal:400, p:16, c:62, f:10, time:15, ing:["ბ.80გ","ლ.ვ.ფ. 60გ","ზ.ი. 1ჩ","ნ.","მ."] },
    { id:"b27", name:"ინ.ომ.+ბ.+ვ.",             emoji:"🌿", kcal:350, p:20, c:38, f:12, time:10, ing:["კვ.3ც","ბ. 1/2","ვ. 1ც","მ.","ნ.","ზ.1ჩ"] },
    { id:"b28", name:"პ.შ.+ა.+ბ.",               emoji:"🍌", kcal:370, p:32, c:42, f:6,  time:3,  ing:["პ.შ. 1სკ.","ა. 1","ბ.+ი.100მლ","ყ.ი.100გ","ვ.1ჩ"] },
    { id:"b29", name:"ჩვ.ქ.+ყ.+კ.",             emoji:"🥚", kcal:480, p:26, c:44, f:20, time:25, ing:["ჩ.ც. 2","ს.ყ.40გ","კ.1ჩ","კვ.1","პ.1ნ","მ."] },
    { id:"b30", name:"კვ.+პ.+ა.",                emoji:"🧆", kcal:440, p:22, c:48, f:16, time:15, ing:["კვ.2","პ.2ნ","ა.1/2","ლ.","ზ.ი.1ჩ","მ."] },
    { id:"b31", name:"ბ.ი.ფ.+ბ.",               emoji:"🫐", kcal:320, p:16, c:48, f:6,  time:5,  ing:["ბ.იოგ.200გ","ბ.კ. 80გ","ვ.1ჩ","ჩ.5გ","ნ.10გ"] },
    { id:"b32", name:"შვ.+ო.+ბ.",               emoji:"🍫", kcal:460, p:15, c:68, f:14, time:7,  ing:["შვ.80გ","ო.ბ.1ჩ","ბ.1","ნ.20გ","ვ.1ჩ","კ.200მლ"] },
    { id:"b33", name:"პ.+ლ.+ი.",                emoji:"🥗", kcal:350, p:28, c:22, f:16, time:8,  ing:["ლ.ვ.ფ.80გ","ი.ო.100გ","კ.ო.","პ.1","ლ.","ზ.ო."] },
    { id:"b34", name:"ც.+ვ.+ბ.ნ.",             emoji:"🍓", kcal:330, p:18, c:44, f:8,  time:5,  ing:["ც.ყ.100გ","ვ.1ც","ბ.კ.50გ","ნ.15გ","ვ.1ჩ"] },
    { id:"b35", name:"ო.ბ.+კ.+ბ.",             emoji:"🥞", kcal:420, p:14, c:66, f:10, time:15, ing:["ო.ბ.80გ","კ.1","ბ.1","კ.200მლ","ვ.1ჩ","ც.1ჩ"] },
  ],

  // ── 35 lunch options ───────────────────────────────────────────────────────
  lunch: [
    { id:"l1",  name:"გრილ ქათამი ბრინჯით",      emoji:"🍗", kcal:650, p:52, c:65, f:14, time:30, ing:["ქათ.მკ. 180გ","ბ. 80გ","ბ.ნარ. 100გ","ზ.","სუნ."] },
    { id:"l2",  name:"ლობიო მჭადით",              emoji:"🫘", kcal:560, p:24, c:88, f:10, time:20, ing:["ლ. 200გ","მჭ. 2ნ","ნ.","ქ.","კ."] },
    { id:"l3",  name:"ორაგული კარტოფ.",           emoji:"🐟", kcal:680, p:48, c:55, f:22, time:25, ing:["ო. 180გ","კ. 200გ","ი. 50გ","ლ.","ზ."] },
    { id:"l4",  name:"ქათმის სუპი",               emoji:"🍲", kcal:420, p:32, c:38, f:12, time:35, ing:["ქ. 150გ","კ.2","ნ.2","ს.2","ქ.","პ."] },
    { id:"l5",  name:"მაკ.ხ.სოუსით",             emoji:"🍝", kcal:680, p:38, c:82, f:18, time:25, ing:["მ.200გ","მ.ფ.150გ","პ.სოუ.","ნ.","ბ.ყ.30გ"] },
    { id:"l6",  name:"ხინკალი (6 ც.)",            emoji:"🥟", kcal:510, p:36, c:54, f:18, time:40, ing:["ხ.6ც","ქ.სუ.200მლ","შ.პ.","ახ.ი."] },
    { id:"l7",  name:"ჩახოხბილი",                 emoji:"🍛", kcal:620, p:44, c:28, f:32, time:40, ing:["ქ.250გ","პ.2","ნ.2","ბ.პ.1","ქ.","სუნ."] },
    { id:"l8",  name:"ს.სტ.სალ.",                emoji:"🥩", kcal:720, p:56, c:18, f:42, time:20, ing:["ბ.200გ","ახ.ს.","ა.ზ.","ლ.","მ/პ."] },
    { id:"l9",  name:"ლობიანი",                   emoji:"🥙", kcal:580, p:22, c:78, f:16, time:35, ing:["ც. 120გ","ლ.150გ","ნ.","კ.","ც.ყ.1ჩ"] },
    { id:"l10", name:"ტუნა-ბრ.ბოული",            emoji:"🍱", kcal:600, p:42, c:68, f:12, time:15, ing:["ტ.120გ","ბ.90გ","ა.1/2","კ.ო.","ბ.კ.","კ.ბ."] },
    { id:"l11", name:"ქ.ნიგვ.სოუ.",              emoji:"🌰", kcal:650, p:46, c:24, f:38, time:35, ing:["ქ.200გ","ნ.60გ","ნ.ნ.","ნ.ყ.","კ.","სუნ."] },
    { id:"l12", name:"კვ.ბოსტ.ბოული",            emoji:"🥦", kcal:490, p:20, c:72, f:14, time:25, ing:["კვ.90გ","ბ.პ.1","ყ.1","ი.50გ","ლ.ი.","ზ.ზ."] },
    { id:"l13", name:"ინდ.ბოსტ.ნ.",              emoji:"🦃", kcal:520, p:46, c:32, f:16, time:30, ing:["ი.ფ.180გ","ყ.1","ბ.პ.1","პ.1","ო.ზ."] },
    { id:"l14", name:"ბ.ქათ.ბულ.",               emoji:"🍜", kcal:440, p:36, c:38, f:10, time:30, ing:["ქ.150გ","ბ.100გ","ნ.1","კ.2","ს.","კ."] },
    { id:"l15", name:"ტ.კვ.ი.",                  emoji:"🥗", kcal:480, p:38, c:22, f:24, time:10, ing:["ტ.120გ","კვ.2","მ.ო.","პ.","ს.ფ.","ლ."] },
    { id:"l16", name:"ხარჩო",                    emoji:"🍲", kcal:580, p:32, c:42, f:28, time:45, ing:["ბ.მ.200გ","ბ.70გ","ნ.50გ","ხ.მჟ.","ქ.","სუნ."] },
    { id:"l17", name:"შემწ.ქათ.ბოსტ.",           emoji:"🍗", kcal:600, p:50, c:28, f:30, time:25, ing:["ქ.200გ","ბ.პ.1","ყ.1","ნ.1","ზ.","სუნ."] },
    { id:"l18", name:"ოჯახ.ბ.ბრ.",              emoji:"🍱", kcal:640, p:40, c:72, f:18, time:35, ing:["ბ.ს.80გ","ბ.90გ","კ.2","ნ.1","ზ.","ს."] },
    { id:"l19", name:"მწვადი + სალ.",            emoji:"🥩", kcal:680, p:58, c:16, f:38, time:30, ing:["ღ.ხ.200გ","ა.ს.","ქ.","ბ.პ.","ლ."] },
    { id:"l20", name:"ბ.+ლ.+ი.",               emoji:"🫙", kcal:530, p:26, c:76, f:12, time:20, ing:["ლ.150გ","ბ.80გ","ი.100გ","ნ.","ზ.ი."] },
    { id:"l21", name:"ს.+ბ.+ყ.",               emoji:"🫘", kcal:510, p:28, c:68, f:12, time:25, ing:["ს.ლ.150გ","ბ.70გ","ყ.40გ","ნ.","ლ.ი.","ზ."] },
    { id:"l22", name:"ტ.ქ.+ბ.",               emoji:"🐟", kcal:570, p:44, c:55, f:16, time:20, ing:["ლ.160გ","ბ.80გ","ლ.","ნ.","ზ.ო.","სუნ."] },
    { id:"l23", name:"პ.+ბ.+ს.",               emoji:"🍝", kcal:620, p:28, c:88, f:14, time:20, ing:["პ.200გ","ბ.ყ.50გ","პ.სოუ.","ნ.","ბ.ი.","ბ."] },
    { id:"l24", name:"ქ.+ყ.+კ.",              emoji:"🥙", kcal:590, p:44, c:38, f:22, time:25, ing:["ქ.150გ","ყ.50გ","კ.1","ნ.","ხ.","ლ.ი."] },
    { id:"l25", name:"ბ.ო.+კ.",               emoji:"🥗", kcal:540, p:36, c:48, f:18, time:20, ing:["ო.130გ","კ.150გ","ი.50გ","ლ.","ო.ზ.","ს."] },
    { id:"l26", name:"ი.+ბ.+კ.",             emoji:"🦃", kcal:510, p:48, c:36, f:14, time:25, ing:["ი.ფ.180გ","ბ.70გ","კ.150გ","ლ.","ზ.","სუნ."] },
    { id:"l27", name:"ს.+ხ.+ბ.",             emoji:"🥩", kcal:660, p:52, c:42, f:28, time:35, ing:["ს.ხ.200გ","ბ.ყ.","ბ.ც.1","ნ.","ქ.","ს.ი."] },
    { id:"l28", name:"ბ.+ა.+ი.",             emoji:"🍱", kcal:500, p:22, c:60, f:18, time:15, ing:["ბ.90გ","ა.1/2","ი.80გ","კ.ო.","ლ.ი.","ზ."] },
    { id:"l29", name:"ქ.+ი.+ბ.",             emoji:"🍗", kcal:580, p:50, c:42, f:18, time:30, ing:["ქ.ბ.180გ","ი.100გ","ბ.70გ","ნ.","ზ.","სუნ."] },
    { id:"l30", name:"მ.+ბ.+კ.",             emoji:"🌿", kcal:560, p:24, c:80, f:14, time:30, ing:["მ.ბ.100გ","ბ.90გ","ბ.ყ.40გ","ნ.","ლ.ი.","ზ."] },
    { id:"l31", name:"ბ.ს.+კ.",             emoji:"🥘", kcal:620, p:46, c:52, f:22, time:40, ing:["ბ.ს.200გ","კ.200გ","ნ.","ქ.","ბ.ი.","სუნ."] },
    { id:"l32", name:"პ.+ბ.+ო.",           emoji:"🍝", kcal:640, p:36, c:86, f:16, time:25, ing:["პ.180გ","ბ.ი.50გ","ო.სოუ.","ნ.","ბ.ყ.","ბ."] },
    { id:"l33", name:"ქ.+ნ.+ყ.",           emoji:"🌿", kcal:600, p:44, c:30, f:32, time:35, ing:["ქ.180გ","ნ.40გ","ბ.ყ.40გ","ქ.","სუნ.","ა."] },
    { id:"l34", name:"ბ.+ი.+ც.",           emoji:"🫘", kcal:540, p:28, c:72, f:14, time:25, ing:["ბ.70გ","ი.100გ","ც.ლ.60გ","ლ.ი.","ნ.","ზ."] },
    { id:"l35", name:"ს.ბ.+ბ.",           emoji:"🍲", kcal:500, p:30, c:56, f:16, time:30, ing:["ს.ბ.150გ","ბ.80გ","ნ.","ქ.","ბ.ი.","ზ."] },
  ],

  // ── 35 dinner options ──────────────────────────────────────────────────────
  dinner: [
    { id:"d1",  name:"ორაგული გამომც.",          emoji:"🐟", kcal:480, p:42, c:8,  f:28, time:20, ing:["ო.180გ","ი.100გ","ნ.","ლ.","ზ.ზ.","სუნ."] },
    { id:"d2",  name:"ქათამი ბ-ბ.ნ.",           emoji:"🍗", kcal:560, p:48, c:55, f:12, time:25, ing:["ქ.180გ","ბ.80გ","ბ-ო.80გ","ზ.ზ.","სუნ."] },
    { id:"d3",  name:"ბოსტ.სუპი",              emoji:"🥣", kcal:280, p:10, c:45, f:6,  time:25, ing:["კ.2","ნ.1","ს.2","ი.80გ","ბ.ყ.","ქ."] },
    { id:"d4",  name:"გ.ინდაური",              emoji:"🦃", kcal:440, p:50, c:12, f:18, time:25, ing:["ი.200გ","ბ.ა.","ბ.პ.","ლ.","ზ.ზ.","ნ."] },
    { id:"d5",  name:"ომ.ბოსტ.ყ.",            emoji:"🍳", kcal:340, p:28, c:10, f:22, time:10, ing:["კვ.3ც","ბ.პ.1/2","ი.ო.","ყ.30გ","ზ."] },
    { id:"d6",  name:"ტუნა სალათი",            emoji:"🥗", kcal:380, p:34, c:18, f:18, time:10, ing:["ტ.120გ","ს.ფ.","პ.1","კ.ო.","ლ.","ზ.ზ."] },
    { id:"d7",  name:"ჩახოხბ.(მ.)",           emoji:"🍲", kcal:520, p:40, c:22, f:26, time:40, ing:["ქ.200გ","პ.2","ნ.2","ბ.პ.1","ქ.","სუნ."] },
    { id:"d8",  name:"ბუდა ბოული",             emoji:"🥙", kcal:490, p:22, c:58, f:18, time:20, ing:["კვ.80გ","ა.1/2","ი.ბ.1/2","ბ.","ი.ო.","ლ.ი."] },
    { id:"d9",  name:"ლ.+ახ.ს.",              emoji:"🐡", kcal:460, p:44, c:14, f:22, time:20, ing:["ლ.180გ","ახ.ი.","პ.1","კ.ო.","ლ.","ზ.ო."] },
    { id:"d10", name:"ი.+ლ.სტ.",             emoji:"🫘", kcal:380, p:22, c:52, f:8,  time:25, ing:["ლ.150გ","ი.100გ","ნ.2","ბ.ყ.1","ლ.","კ."] },
    { id:"d11", name:"ქ.მ.+ი.სოუ.",          emoji:"🍗", kcal:510, p:52, c:18, f:22, time:20, ing:["ქ.200გ","ი.150გ","ნ.1","ნ.ყ.30გ","ბ.ყ.","სუნ."] },
    { id:"d12", name:"კვ.+ბ.+კ.",            emoji:"🥦", kcal:420, p:18, c:62, f:10, time:20, ing:["კვ.80გ","ბ-ო.100გ","კ.2","ნ.1","ლ.ი.","კ."] },
    { id:"d13", name:"ს.სტ.+ბ.პ.",          emoji:"🥩", kcal:600, p:54, c:18, f:32, time:20, ing:["ბ.180გ","ბ.პ.1","ნ.","ლ.","ზ.ო.","სუნ."] },
    { id:"d14", name:"ო.კ.+ყ.+ი-ო.",        emoji:"🍳", kcal:360, p:30, c:8,  f:24, time:12, ing:["კვ.3","ა.კ.50გ","ყ.30გ","ი-ო.50გ","კ."] },
    { id:"d15", name:"ბ.+ტ.+ა.",            emoji:"🥗", kcal:500, p:36, c:52, f:16, time:15, ing:["ბ.70გ","ტ.100გ","ა.1/2","კ.ო.","ლ.ი.","ზ.ზ."] },
    { id:"d16", name:"ბ.სალ.+ი.",           emoji:"🌿", kcal:320, p:14, c:42, f:10, time:10, ing:["ბ.ი.","ი.100გ","პ.1","კ.ო.","ლ.ი.","ზ.ო."] },
    { id:"d17", name:"ქ.+ბ.ი.+ნ.",         emoji:"🍗", kcal:480, p:44, c:36, f:16, time:25, ing:["ქ.160გ","ბ.ი.100გ","ნ.2","ლ.","ზ.ო.","სუნ."] },
    { id:"d18", name:"ბ.ო.+ი.",            emoji:"🐟", kcal:440, p:40, c:20, f:20, time:20, ing:["ო.150გ","ბ.100გ","ლ.","ნ.","ზ.ო.","სუნ."] },
    { id:"d19", name:"ი.+ბ.+ყ.",          emoji:"🥗", kcal:350, p:16, c:46, f:12, time:10, ing:["ბ.ი.100გ","ბ.70გ","ყ.30გ","ლ.ი.","ზ.ო."] },
    { id:"d20", name:"კ.ს.+ბ.",           emoji:"🍲", kcal:390, p:28, c:42, f:12, time:30, ing:["კ.1","ბ.ი.100გ","ბ.80გ","ნ.","ქ.","ბ.ყ."] },
    { id:"d21", name:"ს.ქ.+ბ.პ.",        emoji:"🥩", kcal:560, p:50, c:20, f:28, time:20, ing:["ს.160გ","ბ.პ.1","ი.","ლ.","ზ.ო.","სუნ."] },
    { id:"d22", name:"ლ.+ი.+ბ.",        emoji:"🫘", kcal:400, p:24, c:52, f:10, time:25, ing:["ლ.150გ","ი.80გ","ბ.50გ","ნ.","ბ.ყ.","ლ.ი."] },
    { id:"d23", name:"ო.+ს.+ბ.ი.",      emoji:"🐟", kcal:510, p:42, c:30, f:22, time:25, ing:["ო.150გ","ს.100გ","ბ.ი.80გ","ლ.","ზ.ო.","ს."] },
    { id:"d24", name:"ქ.+ყ.+ბ.",        emoji:"🍗", kcal:530, p:46, c:40, f:18, time:25, ing:["ქ.170გ","ყ.50გ","ბ.80გ","ნ.","ლ.","ზ.ო."] },
    { id:"d25", name:"ბ.+ი.+ა.",        emoji:"🥑", kcal:460, p:18, c:52, f:22, time:15, ing:["ბ.70გ","ი.ო.150გ","ა.1/2","ლ.ი.","ნ.10გ","ზ."] },
    { id:"d26", name:"ს.+ბ.+კ.",       emoji:"🫙", kcal:380, p:34, c:28, f:16, time:10, ing:["ს.120გ","ბ.ი.80გ","კ.ო.","ლ.","ზ.ო.","ს."] },
    { id:"d27", name:"ბ.ს.+ი.",        emoji:"🍲", kcal:340, p:14, c:52, f:8,  time:25, ing:["ბ.ი.100გ","ი.100გ","კ.1","ნ.1","ბ.ყ.","ქ."] },
    { id:"d28", name:"ი.+ბ.+ლ.",      emoji:"🦃", kcal:490, p:48, c:34, f:16, time:25, ing:["ი.ფ.180გ","ბ.70გ","ლ.ვ.ფ.50გ","ლ.","ზ.","სუნ."] },
    { id:"d29", name:"ბ.+ყ.+ი.",      emoji:"🥗", kcal:430, p:20, c:48, f:16, time:15, ing:["ბ.70გ","ყ.40გ","ი.80გ","ლ.ი.","ნ.","ზ.ო."] },
    { id:"d30", name:"ქ.+კ.+ბ.",      emoji:"🍗", kcal:520, p:46, c:42, f:16, time:30, ing:["ქ.160გ","კ.150გ","ბ.70გ","ნ.","ლ.","ს."] },
    { id:"d31", name:"ი.+ო.ბ.",       emoji:"🌿", kcal:370, p:16, c:54, f:10, time:15, ing:["ო.ბ.80გ","ი.100გ","ყ.30გ","ნ.","ლ.ი.","ზ."] },
    { id:"d32", name:"ბ.+ლ.+ყ.",     emoji:"🫘", kcal:410, p:22, c:54, f:12, time:20, ing:["ლ.120გ","ბ.70გ","ყ.30გ","ი.60გ","ლ.ი.","ზ.ო."] },
    { id:"d33", name:"ს.+ბ.+ბ.ი.",  emoji:"🐟", kcal:470, p:40, c:32, f:18, time:20, ing:["ს.140გ","ბ.70გ","ბ.ი.80გ","ლ.","ნ.","ზ."] },
    { id:"d34", name:"ი.+ბ.+ყ.",    emoji:"🥦", kcal:350, p:14, c:52, f:10, time:15, ing:["ი.100გ","ბ.70გ","ყ.30გ","ნ.","ლ.ი.","ზ.ო."] },
    { id:"d35", name:"კ.+ბ.+ი.",    emoji:"🍲", kcal:500, p:38, c:44, f:16, time:30, ing:["კ.160გ","ბ.70გ","ი.90გ","ნ.","ქ.","სუნ."] },
  ],

  // ── 35 drink options ───────────────────────────────────────────────────────
  drinks: [
    { id:"dr1",  name:"მწვ.ჩაი თაფლით",           emoji:"🍵", kcal:25,  p:0,  c:6,  f:0,  time:3,  ing:["მ.ჩ.1ჩ","ც.წ.250მლ","თ.1ჩ","ლ.1ნ."] },
    { id:"dr2",  name:"შავი ყავა",                 emoji:"☕", kcal:5,   p:0,  c:1,  f:0,  time:3,  ing:["ყ.8გ","ც.წ.200მლ"] },
    { id:"dr3",  name:"ნატ.ლიმ.+თ.",              emoji:"🍋", kcal:60,  p:0,  c:15, f:0,  time:5,  ing:["ლ.1ც","ც.წ.300მლ","თ.1ჩ","მ.ყ.4ფ."] },
    { id:"dr4",  name:"კეფირი",                    emoji:"🥛", kcal:100, p:8,  c:12, f:2,  time:1,  ing:["კ.250მლ"] },
    { id:"dr5",  name:"პ.შ.+ბ.+კ.",              emoji:"💪", kcal:200, p:32, c:22, f:3,  time:3,  ing:["პ.შ.1სკ.","ბ.1","კ.200მლ"] },
    { id:"dr6",  name:"ყ.ლ.+ბ.+ა.",             emoji:"🍌", kcal:180, p:6,  c:38, f:2,  time:5,  ing:["ბ.1","ა.1/2","ბ.ი.100გ","ყ.ლ.50მლ","ვ."] },
    { id:"dr7",  name:"ვ.ლ.+კ.",               emoji:"🍎", kcal:110, p:1,  c:28, f:0,  time:5,  ing:["ვ.2ც","ი.ს.1ნ","ლ.1/4","გ.ა.ფ."] },
    { id:"dr8",  name:"ნ.ო.ლ.+კ.",            emoji:"🍊", kcal:105, p:2,  c:25, f:0,  time:5,  ing:["ო.2ც","გ.ა.","ლ.1/4","ვ.ო.ფ."] },
    { id:"dr9",  name:"მ.კ.+ი.+ა.",           emoji:"🌿", kcal:80,  p:3,  c:16, f:1,  time:5,  ing:["ი.ხ.100გ","ბ.1/2","ა.1/2","ლ.ი.","ვ.1ჩ"] },
    { id:"dr10", name:"ვ.ი.+ი.",              emoji:"🍇", kcal:140, p:2,  c:34, f:0,  time:5,  ing:["ვ.ი.150გ","ი.ს.2ნ","ლ.1/4"] },
    { id:"dr11", name:"კ.ი.+ი.",             emoji:"🫐", kcal:90,  p:3,  c:20, f:0,  time:5,  ing:["კ.კ.150გ","ი.ს.1ნ","ვ.ი.2ნ","ლ.ი."] },
    { id:"dr12", name:"ი.+ვ.ა.+ი.",         emoji:"🥤", kcal:150, p:4,  c:32, f:1,  time:5,  ing:["ი.ო.100გ","ვ.ა.1ც","ბ.ი.100გ","ვ."] },
    { id:"dr13", name:"ვ.ი.+კ.",           emoji:"🍵", kcal:35,  p:0,  c:8,  f:0,  time:3,  ing:["ვ.ი.1ჩ","ვ.ი.ი.1ნ","ც.წ.250მლ","ვ."] },
    { id:"dr14", name:"ყ.ც.+ი.",          emoji:"☕", kcal:130, p:4,  c:18, f:5,  time:3,  ing:["ყ.8გ","ი.ც.100მლ","ქ.ც.10გ","შ.1ჩ"] },
    { id:"dr15", name:"ბ.+კ.",            emoji:"🍌", kcal:160, p:5,  c:36, f:1,  time:5,  ing:["ბ.1","კ.200მლ","ვ.1ჩ","ც."] },
    { id:"dr16", name:"ა.ი.+კ.+ვ.",     emoji:"💚", kcal:70,  p:2,  c:14, f:1,  time:5,  ing:["ა.ი.1ჩ","კ.150გ","ვ.","ლ.ი.","ი.ს."] },
    { id:"dr17", name:"ქ.ი.+ი.",        emoji:"🍋", kcal:15,  p:0,  c:4,  f:0,  time:3,  ing:["ქ.1","ვ.ო.ი.2ნ","ც.წ.300მლ","ვ."] },
    { id:"dr18", name:"ი.სმ.+ი.+ვ.",   emoji:"🍓", kcal:170, p:5,  c:36, f:2,  time:5,  ing:["ი.ვ.100გ","ბ.1/2","ბ.ი.100გ","ვ.1ჩ","ი."] },
    { id:"dr19", name:"ა.ი.+ი.",       emoji:"🌿", kcal:45,  p:1,  c:10, f:0,  time:5,  ing:["ა.ი.1ჩ","ლ.1/4","ვ.ო.","ი.ს.1","ც.წ.250მლ"] },
    { id:"dr20", name:"ბ.ი.+ი.",      emoji:"🍇", kcal:120, p:2,  c:28, f:0,  time:5,  ing:["ბ.ი.150გ","ი.ს.2ნ","ლ.ი."] },
    { id:"dr21", name:"ა.+ი.",        emoji:"🥛", kcal:130, p:10, c:18, f:2,  time:1,  ing:["ა.200მლ","ვ.1ჩ"] },
    { id:"dr22", name:"ი.ო.+ი.",     emoji:"🍋", kcal:110, p:1,  c:26, f:0,  time:3,  ing:["ი.ო.1","ვ.ო.ი.","ც.წ.250მლ","ვ."] },
    { id:"dr23", name:"კ.ი.+ი.",    emoji:"🥥", kcal:150, p:1,  c:18, f:8,  time:1,  ing:["კ.ი.200მლ"] },
    { id:"dr24", name:"ბ.+კ.+ი.",  emoji:"💪", kcal:220, p:28, c:24, f:3,  time:3,  ing:["ბ.პ.1სკ.","კ.200მლ","ვ.1ჩ","ი.ო.50გ"] },
    { id:"dr25", name:"ვ.ი.+ი.",  emoji:"🍵", kcal:40,  p:0,  c:10, f:0,  time:3,  ing:["ვ.ი.1ჩ","ც.წ.250მლ","ვ.1ჩ","ლ."] },
    { id:"dr26", name:"ა.ი.+ბ.", emoji:"🍹", kcal:95,  p:1,  c:22, f:0,  time:5,  ing:["ა.ი.100მლ","ბ.1/2","ი.ს.1ნ","ვ."] },
    { id:"dr27", name:"ი.ო.+ი.", emoji:"🍵", kcal:20,  p:0,  c:5,  f:0,  time:3,  ing:["ი.ო.ი.1ჩ","ც.წ.250მლ","ლ.ი.","ვ."] },
    { id:"dr28", name:"ბ.+ი.+ი.", emoji:"🫙", kcal:190, p:5,  c:42, f:1,  time:5,  ing:["ბ.1","ი.ვ.80გ","კ.150მლ","ვ.1ჩ","ჩ.3გ"] },
    { id:"dr29", name:"ყ.+ი.",   emoji:"☕", kcal:55,  p:2,  c:8,  f:2,  time:3,  ing:["ყ.8გ","ი.ც.80მლ","ც.წ.120მლ"] },
    { id:"dr30", name:"ბ.ი.+ი.+ვ.", emoji:"🌿", kcal:75,  p:2,  c:16, f:1,  time:5,  ing:["ბ.ი.100გ","ი.ი.2ნ","ლ.ი.","ც.წ.200მლ","ვ."] },
    { id:"dr31", name:"ი.+ი.+ბ.", emoji:"🥤", kcal:140, p:4,  c:28, f:2,  time:5,  ing:["ა.ი.80გ","კ.80მლ","ბ.1/2","ვ.1ჩ","ლ."] },
    { id:"dr32", name:"ი.+ი.",   emoji:"🍵", kcal:30,  p:0,  c:7,  f:0,  time:3,  ing:["ი.ი.1ჩ","ც.წ.250მლ","ვ.1ჩ","ლ.ი."] },
    { id:"dr33", name:"ბ.+ი.+კ.", emoji:"💪", kcal:240, p:30, c:26, f:2,  time:3,  ing:["ბ.პ.1სკ.","ბ.1","კ.200მლ","ო.ბ.20გ"] },
    { id:"dr34", name:"ი.+ი.+ვ.", emoji:"🍋", kcal:50,  p:0,  c:12, f:0,  time:3,  ing:["ი.ი.1ჩ","ი.ო.ი.","ც.წ.300მლ","ვ."] },
    { id:"dr35", name:"კ.+ი.+ა.", emoji:"🥝", kcal:110, p:2,  c:26, f:0,  time:5,  ing:["კ.ი.1ც","ი.სახ.1","ა.1/2","ი.ს.2ნ","ვ."] },
  ],
};
...
function ProfilePage({ profile, onLogout, onAdmin }) {
  const { state, updateState, showToast } = useContext(Ctx);
  ...
  const startW  = weight.history?.[0] ?? weight.current;
  const totalDrop = startW - weight.goal;                          // kg to lose total
  const dropped   = startW - weight.current;                       // kg dropped so far
  const progPct   = totalDrop > 0 ? Math.min(100, Math.max(0, Math.round((dropped / totalDrop) * 100))) : 0;
  const diffKg    = (weight.current - weight.goal).toFixed(1);     // remaining
  const changeSinceStart = (weight.current - startW).toFixed(1);  // e.g. -1.2
    ...
    <div style={{ padding: "0 16px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 14, padding: "16px 0 12px" }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 12, color: "var(--t2)", marginTop: 2 }}>{profile?.height && profile?.weight ? `${profile.height}სმ • ${profile.weight}კგ` : ""}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 8, marginBottom: 12 }}>
        {[
          ["წონა",   `${weight.current}კგ`, undefined],
          ["მიზანი", `${weight.goal}კგ`,    undefined],
        ...
        <div className="fu">
          ...
          <div className="card" style={{ marginBottom: 12 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
              <div>
                ...
                <div style={{ fontSize: 22, fontWeight: 900 }}>{weight.current}<span style={{ fontSize: 12, color: "var(--t2)", fontWeight: 400 }}> კგ</span></div>
              </div>
          ...
          <div className="card">
            {[
              ...
              { I: BarChart3, l: "BMI",       v: profile?.height && profile?.weight ? (profile.weight / ((profile.height/100)**2)).toFixed(1) : "-", c: "var(--org)" },
            ].map(item => (
              <div key={item.l} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 0", borderBottom: "1px solid var(--bdr)" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, overflow: "hidden", flex: 1 }}>
            ...
            {added.length > 0 && (
              <div style={{ display: "flex", gap: 6, overflowX: "auto", paddingBottom: 2 }}>
                {added.map((f, i) => (
                  <div key={i} style={{ background: "var(--acc-dim)", border: "1px solid var(--bdr-a)", borderRadius: 20, padding: "4px 11px", fontSize: 12, color: "var(--acc)", flexShrink: 0, display:"flex", alignItems:"center", gap:4 }}>
                    {f.emoji} {f.kcal} kcal
                  </div>
                ))}
              </div>
            ...
            {/* ძებნა */}
            <input className="inp" placeholder="🔍 ძებნა ქართული საკვები..." value={search} onChange={e => { setSearch(e.target.value); if(e.target.value) setFoodCat("ყველა"); }} />
            {/* კატეგორიები */}
            ...
            {added.length > 0 && (
              <button className="btn" onClick={() => {
                updateState(p => ({ calories: { ...p.calories, current: p.calories.current + added.reduce((s,f)=>s+f.kcal,0) }, diary: { ...p.diary, snacks: [...p.diary.snacks, ...added.map((f,i)=>({...f,id:Date.now()+i}))] } }));
                showToast(`${added.length} საკვები შენახულია ✓`);
                onClose();
              }}>{added.length} საკვების შენახვა ({added.reduce((s,f)=>s+f.kcal,0)} kcal)</button>
            )}
          </div>
        )}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            {scanDone ? (
              <div className="card">
                ...
                <button className="btn" style={{ marginTop: 12 }} onClick={() => { updateState(p => ({ calories: { ...p.calories, current: p.calories.current + 255 }, diary: { ...p.diary, snacks: [...p.diary.snacks, { id: Date.now(), name: "ხინკალი × 3", emoji: "🥟", kcal: 255, protein: 18, carbs: 27, fat: 9 }] } })); showToast("🥟 დამატებულია!"); onClose(); }}>კვების დღიურში დამატება</button>
              </div>
...
export default function FitGeo() {
  ...
  useEffect(() => {
    if (!api.getToken()) { setAppLoading(false); return; }
    api.getState()
      .then(data => {
        if (data?.appState) setState(data.appState);
        if (data?.profile) { setProfile(data.profile); localStorage.setItem("fitgeo_profile", JSON.stringify(data.profile)); }
      })
      .catch(() => {})
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => { api.saveState(state).catch(() => {}); }, 1500);
  ...
  const handleOnboardingDone = (profileData, serverState) => {
    ...
    // Use backend-calculated state if available, otherwise compute locally
    setState(serverState ?? makeCleanState(profileData));
  };
    ...
    <Ctx.Provider value={{ state, updateState, showToast, profile }}>
      ...
      <div className="app">
        <div className="page">
          ...
          {tab === "profile" && <ProfilePage profile={profile} onLogout={handleLogout} onAdmin={profile?.isAdmin ? () => setShowAdmin(true) : null} />}
        </div>
        <nav className="bnav">
